...
if (!defined('CONNECT_TIMEOUT_MS')) {
    define('CONNECT_TIMEOUT_MS', 900);
}
if (!defined('REQUEST_TIMEOUT_MS')) {
    define('REQUEST_TIMEOUT_MS', 1800);
}
if (!defined('LOGFILE')) {
    define('LOGFILE', NULL);
}
...
if(!defined('KEY_1')) {
    define('KEY_1', "t8Sn7cvBv2554444455ggghzzzn8duxU28eUxqd6i+gJywzoNo72ItPEtdU=");
}
if(!defined('KEY_2')) {
    define('KEY_2', "zCeopESQfMDIVekrmrmmtt444444ZTQjm52lbdnQ7iC2RgLuh3RAhexU=");
}
